...
Como se puede visualizar, las actividades realizadas dentro de la presente unidad están organizadas en carpetas diferenciadas por enlaces con distintos colores. Cada uno de estos enlaces dirige a una sección de tareas específicas dentro del portafolio digital.  
Estas actividades se dividen en tres categorías principales:

- **ACD:** Actividades en Contacto con el Docente  
...
# 🟦 ACD (Actividad en Contacto con el docente)

## Descripción:
En esta seccion de actividades, pudimos realizar varias diapositivas, diseñadas con la ayuda de la Inteligencia Artificial Generativa (Gamma), la misma que nos ayudo a organizar de una mejor manera, los contenidos investigados de manera autonoma, plasmandolos dentro de las diapositivas, ofreciendo un mejor formato tanto de presentacón, como de organización de la información, contando con tablas, organizadores graficos, entre otros aspecto que la IA nos ayudo a generar.Los temas de estas diapositivas son los siguientes:

- Para la primera diapositiva: En primera diapositiva,  los temas fueran, proposiciones logicas, operadores logicos y tablas de verdad, todo esto fue la base, al principio no entendiamos para que nos servirían estos temas, pero mas adelante en la siguiente diapositiva, se puede ver bastante claro, en que nos ayudó, haber analizado y comprendido eestos temas en primer lugar.
...
[![📘 APE](https://img.shields.io/badge/📘_APE-32CD32?style=for-the-badge)](./APE/index.md)
...
[![📙 AA](https://img.shields.io/badge/📙_AA-FFA500?style=for-the-badge)](./AA/index.md)
